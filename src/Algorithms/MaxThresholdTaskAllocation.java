...
public class MaxThresholdTaskAllocation extends AbstractTaskAllocationAlgorithm {
    public MaxThresholdTaskAllocation(List<Task> tasks, HashMap<Integer, Processor> processors, InputParams inputParams) {
        super(tasks, processors, inputParams);
    }

    @Override
    public TaskAllocationAlgorithmType getAlgorithmType() {
        return TaskAllocationAlgorithmType.MAX_THRESHOLD;
    }
